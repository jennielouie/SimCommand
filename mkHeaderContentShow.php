...
<a class="alwaysShow button tiny" href="/SimCommandEditCaseForm.php?case_id=<?php echo $this->caseID; ?>">Edit This Case</a>
...
<a class="alwaysShow button tiny" href="/SimCommandGetCaseStates.php?case_id=<?php echo $this->caseID; ?>">Edit Case States</a>
    </div>
  </div>
</div>
