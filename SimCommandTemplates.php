...
$stateNew = new Template('mkOneStateObjectNew.php', array(
  ...
  'temp_celciuslabel'=>'Temperature (Celsius)',
  'resp_ratelabel'=>'Respiration Rate',
  'heart_ratelabel'=>'Heart Rate',
  'noteslabel'=>'Notes',
  'generallabel'=>'General',
  'bp_systoliclabel'=>'BP Systolic',
  'bp_diastoliclabel'=>'BP Diastolic',
  'spo2label'=>'SpO2',
  'weightlabel'=>'Weight',
  'pain_scorelabel'=>'Pain Score',
  'otherlabel'=>'Other',
  'discussion_itemslabel'=>'Discussion Items',
  'type'=>'oneState',
  'actions'=>array($action1, $action2),
  'pe_generallabel'=>'Physical Exam General',
  'heentlabel'=>'HEENT',
  'necklabel'=>'Neck',
  'lungslabel' =>'Lungs',
  'heartlabel'=>'Heart',
  'abdomenlabel'=>'Abdomen',
  'extremetieslabel'=>'Extremities',
